...
<Steps>
  ...
  <Step title="Set up your environment" stepNumber={2}>
    ### Configure
  ...
  <Step title="Connect to a computer" stepNumber={3}>
    ### Connect
  ...
  <Step title="Perform actions" stepNumber={4}>
    ### Control
  ...
  <Step title="Integrate with Anthropic" stepNumber={5}>
    ### Integrate
  ...
  <Step title="Clean up" stepNumber={6}>
    ### Cleanup
